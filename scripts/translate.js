...
const MOVEMENTS = [
	...
	["forward-lunge-triceps-extension", "Extensión de tríceps en zancada frontal"],
	...
	["cable-twist-up-down", "Giro en polea arriba y abajo"],
	// Sitted (typo in slugs = seated)
	["barbell-sitted-alternate-leg-raise-female", "Elevación de piernas con barra, alternado, sentado"],
	["barbell-sitted-alternate-leg-raise", "Elevación de piernas con barra, alternado, sentado"],
	// Pull-in exercises
	["leg-pull-in-flat-bench", "Encogimiento de piernas en banco plano"],
	["pull-in-on-stability-ball", "Encogimiento en fitball"],
	// Frases de medicine ball (muy específicas)
	["lower-body-rotation", "Rotación de tren inferior"],
	...
	// Rotaciones de hombro/cadera
	["cable-seated-shoulder-internal-rotation", "Rotación interna de hombro en polea, sentado"],
	["cable-standing-shoulder-external-rotation", "Rotación externa de hombro en polea, de pie"],
	["dumbbell-lying-external-shoulder-rotation", "Rotación externa de hombro con mancuerna, tumbado"],
	["dumbbell-upright-shoulder-external-rotation", "Rotación externa de hombro con mancuerna, erguido"],
	["band-lying-hip-internal-rotation", "Rotación interna de cadera con banda, tumbado"],
	["band-seated-hip-internal-rotation", "Rotación interna de cadera con banda, sentado"],
	// Pull through
	["band-pull-through", "Tirón entre piernas con banda"],
	["cable-pull-through-with-rope", "Tirón entre piernas en polea, con cuerda"],
	["dumbbell-sumo-pull-through", "Tirón entre piernas sumo con mancuerna"],
	// Cardio terms
	["walk-elliptical-cross-trainer", "Caminata en elíptica"],
	["run-equipment", "Correr en máquina"],
	["wheel-run", "Correr en rueda"],
	// Glutes specific
	...
	["arms-apart-circular-toe-touch-male", "Tocar punta del pie con brazos separados, circular"],
	["hands-clasped-circular-toe-touch-male", "Tocar punta del pie con manos juntas, circular"],
	["hands-reversed-clasped-circular-toe-touch-male", "Tocar punta del pie con manos invertidas, circular"],
	["basic-toe-touch-male", "Tocar punta del pie, básico"],
	// Self-assisted
	["self-assisted-inverse-leg-curl-1766", "Curl femoral nórdico autoasistido"],
	["self-assisted-inverse-leg-curl-on-floor", "Curl femoral nórdico autoasistido en el suelo"],
	["self-assisted-inverse-leg-curl", "Curl femoral nórdico autoasistido"],
	// Lats underhand
	["band-fixed-back-close-grip-pulldown", "Jalón al pecho con banda, agarre cerrado, espalda fija"],
	["band-fixed-back-underhand-pulldown", "Jalón al pecho con banda, agarre supino, espalda fija"],
	["band-underhand-pulldown", "Jalón al pecho con banda, agarre supino"],
	["cable-underhand-pulldown", "Jalón al pecho en polea, agarre supino"],
	// Weighted with swing
	["weighted-kneeling-step-with-swing", "Paso de rodillas con peso y balanceo"],
	["weighted-lunge-with-swing", "Zancada con peso y balanceo"],
	// Barbell rack pull
	["barbell-rack-pull", "Rack pull con barra"],
	// Push press (acceptable anglicism)
	["dumbbell-push-press", "Push press con mancuerna"],
	["kettlebell-double-push-press", "Push press doble con kettlebell"],
	["kettlebell-one-arm-push-press", "Push press con kettlebell, a una mano"],
	// Calves
	["standing-calves-calf-stretch", "Estiramiento de gemelo de pie"],
	["smith-toe-raise", "Elevación de puntas en Smith"],
	...
	["dumbbell-full-can-lateral-raise", "Elevación lateral con mancuerna, estilo lata llena"],
...
const GRIPS = {
	...
	"clean-grip": "con agarre de cargada",
...
const MODIFIERS = {
	...
	pike: "en pike",
	kipping: "con kipping",
	"depth-jump": "con salto en profundidad",
	"world-greatest": "el mejor del mundo",
	"clock-push-up": "reloj",
	...
	"skin-the-cat": "vuelta completa en barra",
	"inverted-row": "remo invertido",
	...
	"glute-ham-raise": "elevación glúteo-isquiotibial",
	"kick-out-sit": "patada y sentadilla",
